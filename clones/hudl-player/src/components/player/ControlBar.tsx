...
function HoldButton({ handlers, label, children }: { handlers: HandlerPair; label: string; children: React.ReactNode }) {
  return (
    <button
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-standard text-text hover:bg-white/10 active:bg-accent-blue/30"
    ...
    <div className="flex items-center justify-between gap-4 px-3 py-2">
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-accent-blue text-white hover:brightness-110"
        >
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className={`rounded-standard p-1.5 ${looping ? 'bg-accent-blue/20 text-accent-blue' : 'text-text hover:bg-white/10'}`}
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className={`rounded-standard p-1.5 ${drawMode ? 'bg-accent-blue/20 text-accent-blue' : 'text-text hover:bg-white/10'}`}
